...
namespace TradingBrain.Models
{
    ...
    public class MainApp
    {
        ...
        public async void EditDeal(double stopLoss, string dealID, double stopLossVar)
        {
            try
            {
                ...
                if (ret != null)
                {
                    clsCommonFunctions.AddStatusMessage($"Edit deal - Status: {ret.StatusCode} = stopLevel = {pos.stopLevel}, trailingStopDistance = {pos.trailingStopDistance}, trailingStopIncrement = {pos.trailingStopIncrement} " , "INFO");
                    TradingBrain.Models.clsCommonFunctions.SaveLog("Info", "EditDeal", $"Edit deal - Status: {ret.StatusCode} = stopLevel = {pos.stopLevel}, trailingStopDistance = {pos.trailingStopDistance}, trailingStopIncrement = {pos.trailingStopIncrement} ", the_app_db);
                    if (ret.StatusCode.ToString() == "Unauthorized")
                    {
                        newsession = true;
                    }
       ...
       public async Task<runRet> RunCode(object sender, System.Timers.ElapsedEventArgs e)
                                    ...
                                    if ((IGModels.clsCommonFunctions.Dbl2DP((double)model.thisModel.currentTrade.buyPrice - Math.Abs(model.thisModel.currentTrade.stopLossValue)) != IGModels.clsCommonFunctions.Dbl2DP((double)this.currentTrade.stopLevel)) && (IGModels.clsCommonFunctions.Dbl2DP((double)model.thisModel.currentTrade.stopLossValue) != IGModels.clsCommonFunctions.Dbl2DP((double)this.currentTrade.stopLevel)))
                                    {
                                        ...
                                        if (model.modelVar.breakEvenVar == 1)
                                        {
                                            ...
                                            if (model.onSuppTrade && this.suppTrade != null)
                                            {
                                                ...
                                                EditDeal((double)model.thisModel.currentTrade.buyPrice + model.thisModel.currentTrade.stopLossValue, this.suppTrade.dealId, model.thisModel.currentTrade.stopLossValue);
                                            }
                                        }
                                        else

                                        {
                                            ...
                                            if (model.onSuppTrade)
                                            {
                                                ...
                                                EditDeal((double)this.currentTrade.stopLevel, this.currentTrade.dealId, model.thisModel.currentTrade.stopLossValue);
                                            }
                                            else
                                            {
                                                this.currentTrade.stopLevel = (decimal)model.thisModel.currentTrade.buyPrice - (decimal)model.thisModel.currentTrade.stopLossValue;
                                ...
                                if (model.shortOnMarket)
                                {
                                    ...
                                    if ((IGModels.clsCommonFunctions.Dbl2DP((double)model.thisModel.currentTrade.sellPrice + Math.Abs(model.thisModel.currentTrade.stopLossValue)) != IGModels.clsCommonFunctions.Dbl2DP((double)this.currentTrade.stopLevel)) && (IGModels.clsCommonFunctions.Dbl2DP((double)model.thisModel.currentTrade.stopLossValue) != IGModels.clsCommonFunctions.Dbl2DP((double)this.currentTrade.stopLevel)))
                                    {
                                        ...
                                        if (model.modelVar.breakEvenVar == 1)
                                        {
                                            ...
                                            EditDeal((double)model.thisModel.currentTrade.sellPrice - model.thisModel.currentTrade.stopLossValue, this.currentTrade.dealId, model.thisModel.currentTrade.stopLossValue);
                                            ...
                                            if (model.onSuppTrade && this.suppTrade != null)
                                            {
                                                ...
                                                EditDeal((double)model.thisModel.currentTrade.sellPrice - model.thisModel.currentTrade.stopLossValue, this.suppTrade.dealId, model.thisModel.currentTrade.stopLossValue);
                                            }
                                        }
                                        else
                                        {
        ...
        public async Task<runRet> iGUpdate (updateMessage msg)
        {
            ...
            {
                case "UPDATE":
                Console.WriteLine($"Update Message: {msg.itemName} - {msg.updateData}");
                    OPUUpdate(msg.updateData, msg.itemName);
                    break;
                case "CONFIRM":
                    Console.WriteLine($"Confirm Message: {msg.itemName} - {msg.updateData}");
                    ...
                    if (tsm.Epic == this.epicName)
                    {
                        ...
                        if (reqTrade != null)
                        {
                            ...
                            if (tsm.Status == null & tsm.Reason != "SUCCESS")
                            {
                                ...
                                clsCommonFunctions.AddStatusMessage($"CONFIRM - failed - deal type = {reqTrade.dealType} - {tsm.Reason} - {this.TradeErrors[tsm.Reason]}", "INFO");
