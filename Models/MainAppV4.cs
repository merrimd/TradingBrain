...
namespace TradingBrain.Models
{
    ...
    public class MainApp
    {
        ...
        public  async Task RunMainAppCode(object sender, System.Timers.ElapsedEventArgs e)
        {
            ...
            switch (strategy)
            {
                ...
                case "BOLLI":
                    //task = Task.Run(() => RunCode_BOLLI(sender, e));
                    await RunCode_BOLLI(sender, e);
                    //parallelTasks.Add(task);
                    break;
                case "GRID":
                    //task = Task.Run(() => RunCode_GRID(sender, e));
                    await RunCode_GRID(sender, e);
                    //parallelTasks.Add(task);
                    break;
                default:
                    //task = Task.Run(() => RunCodeV5(sender, e));
                    await RunCodeV5(sender, e);
                    //parallelTasks.Add(task);
                    break;
            ...
            //{
            //    case "HOUR":
            //        t.Interval = GetIntervals.GetIntervalWithResolution(region,"HOUR");
            //        break;

            //    case "SECOND":
            //        t.Interval = GetIntervals.GetIntervalSecond(region);
            //        clsCommonFunctions.AddStatusMessage($"Next GRID interval set to : {t.Interval} ms", "INFO");
            //        break;

            //    default:
            //        t.Interval = GetIntervals.GetInterval(region,strat);
            //        break;
            //}
        ...
        public MainApp(Database db, Database appDb, string epic,  Container _candles_RSI_container, Container _trade_container, IGContainer igContainer, IGContainer igContainer2, string strategy = "SMA", string resolution = "")
        {
            try
            {
                    ...
                    try
                    {
                        ...
                        else
                        {
                            ...
                            if (gotCandle)
                            {
                                ...
                                {
                                    clsCommonFunctions.AddStatusMessage($"current long bollid = {this.gridLID}", "DEBUG");
                                ...
                                {
                                    clsCommonFunctions.AddStatusMessage($"current short bollid = {this.gridSID}", "DEBUG");
                                    ...
                                    if (this.strategy == "GRID")
                                    {
                                        ...
                                        if (matchTrade != null)
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                clsCommonFunctions.SendBroadcast("BuyShort", JsonConvert.SerializeObject(dbTrade), this.the_app_db);
                                            }
